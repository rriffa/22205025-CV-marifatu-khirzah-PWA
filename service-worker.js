...
const urlsToCache = [
  ...
  "/public_html/assets/js/jonhdoe.js",
  "/public_html/assets/imgs/profile.jpg",
  "/public_html/assets/imgs/icon-192x192.png",
  "/public_html/assets/imgs/icon-512x512.png",
  ...
  "/public_html/assets/vendors/isotope/isotope.pkgd.js",
];
...
messaging.onBackgroundMessage((payload) => {
  ...
  const notificationOptions = {
    ...
    icon: "/public_html/assets/imgs/profile.jpeg",
  };
